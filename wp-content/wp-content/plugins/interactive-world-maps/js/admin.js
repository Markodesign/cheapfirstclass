	...
	function isolink() {	 	
	  ...
	  if(resolution == 'metros' && display == "regions") {
		...
		latlonhide();	
		 ...
		 span.innerHTML = '<b>Text Markers</b> - When using the Text Markers display mode, a colored text will be added to the specified region. When this mode is selected you can also use a a specific string address (for example, "1600 Pennsylvania Ave") or Berlin Germany as a Region Code. DO NOT use commas (,) or quotes("").<br /><strong>If you experience slow loading of the Markers, consider using Coordinates values in the Regions Code.</strong>'; // 
		 ...
		 span.innerHTML = '<b>Round Markers (Text Code)</b> - When using the Markers display mode, a colored bubble will be added to the specified region. When this mode is selected you can also use a a specific string address (for example, "1600 Pennsylvania Ave") or Berlin Germany as a Region Code. DO NOT use commas (,) or quotes("").<br /><strong>If you experience slow loading of the Markers, consider using Markers (Coordinates) Display Mode.</strong>'; // 
		 ...
		 span.innerHTML =  '<b>Round Markers (Coordinates Code)</b> - When using the Markers display mode, a colored bubble will be added to the specified region. When the Coordinates mode is chosen, you should insert the coordinates values in the Region Code, in this format: latitude longitude. <strong>Do not use commas, use a space to separate de values</strong>. Example:34.3071438 -53.7890625'; // 
		 latlonshow();
