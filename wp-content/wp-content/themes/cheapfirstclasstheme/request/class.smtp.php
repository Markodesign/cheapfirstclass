...
function _sendEmail($email, $subject, $message)
        {
            ...
            $mail->AddReplyTo("noreply@cheapfirstclass.com", "=?utf-8?B?" . base64_encode('CheapFirstClass.com') . "?=");
            $mail->SetFrom('noreply@cheapfirstclass.com', "=?utf-8?B?" . base64_encode('CheapFirstClass.com') . "?=");
            $mail->Subject    = '=?utf8?B?' . base64_encode($subject) . '?=';
            $sended = true;
