...
if(!empty($_REQUEST['template_page']) or !empty($_SESSION['template_page'])){
    ...
    if($_REQUEST['template_page']==2 or $_SESSION['template_page']==2){
        $_SESSION['template_page'] = 2;
        include_once('main-page_2.php');
    }
    if($_REQUEST['template_page']==3 or $_SESSION['template_page']==3){
        $_SESSION['template_page'] = 3;
        include_once('main-page_3.php');
    }
    if($_REQUEST['template_page']==4 or $_SESSION['template_page']==4){
        $_SESSION['template_page'] = 4;
        include_once('main-page_4.php');
    }
    if($_REQUEST['template_page']==5 or $_SESSION['template_page']==5){
        $_SESSION['template_page'] = 5;
        include_once('main-page_5.php');
    }
    if($_REQUEST['template_page']==6 or $_SESSION['template_page']==6){
        $_SESSION['template_page'] = 6;
        include_once('main-page_6.php');
    }
    if($_REQUEST['template_page']==7 or $_SESSION['template_page']==7){
        $_SESSION['template_page'] = 7;
        include_once('main-page_7.php');
    }
    if($_REQUEST['template_page']==8 or $_SESSION['template_page']==8){
        $_SESSION['template_page'] = 8;
        include_once('main-page_8.php');
    }
    if($_REQUEST['template_page']==9 or $_SESSION['template_page']==9){
        $_SESSION['template_page'] = 9;
        include_once('main-page_9.php');
    }
    if($_REQUEST['template_page']==10 or $_SESSION['template_page']==10){
        $_SESSION['template_page'] = 10;
        include_once('main-page_10.php');
    }
}else {
    ...
    <div class="container">
        ...
        <div class="top-destination">
            <div class="middle-row">
                ...
                <div class="grid9">
                    <img id='map' src="https://cheapfirstclass.com/wp-content/uploads/2016/05/123.jpg" width="100%"
                         alt="top destinations for business class flights"/>
                ...
                <div class="grid3">
                    <div class="dest-description">
                        ...
                        <p>Looking for pricing or additional information on our first class flight deals and business
                            class airfare specials? Call us right now. </p>
            ...
            <div class="middle-row">
                <div class="grid12">
                    ...
                    <ul news-comp-logos>
                        ...
                        <li><img src="/wp-content/themes/cheapfirstclasstheme/images/san-francisco-chronicle.png"
                                 alt="san-francisco-chronicle"/></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="front-page-text">
            <div class="middle-row">
                <div class="grid12">
                    ...
                    <?php $contact_drop = new WP_Query('pagename=/front-page-text/');
                    while ($contact_drop->have_posts()) : $contact_drop->the_post();
