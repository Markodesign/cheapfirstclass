<?php
###########################################################
#      This file is identical to docs/_index.php.txt       #
#  It exists only for backward-compatiblity with go-pear  #
###########################################################

/**
 * Put this file in a web-accessible directory as _index.php (or similar)
 * and point your webbrowser to it.
 */

// $pear_dir must point to a valid PEAR install (=contains PEAR.php)
$pear_dir = '/media/storage/www/gameraise/pear/PEAR'; // default of install
